...
return [
    ...
    'menu_recent_reservation' => 'Reservaciones recientes',
    ...
    'alert_error_nothing' => 'Se ha producido un error, nada %s.',
    'alert_error_try_again' => 'Se ha producido un error. Por favor, inténtalo de nuevo.',
    ...
    'alert_no_search_query' => 'Por favor ingresa una dirección/código postal para comprobar si podemos entregar tu pedido.',
    'alert_info_outdated_browser' => 'Estás utilizando un navegador antiguo. <a href="http://browsehappy.com/"> Actualiza tu navegador</a> o <a href="http://www.google.com/chromeframe/?redirect=true">instala Google Chrome </a> para una mejor experiencia en este sitio.',
    ...
    'media_manager' => [
        ...
        'alert_file_name_required' => 'Por favor, introduzca un nuevo nombre de archivo/carpeta.',
        'alert_invalid_file_name' => 'Nombre de archivo/carpeta inválido',
        'alert_invalid_new_file_name' => 'El nuevo nombre de archivo/carpeta no es válido',
        ...
        'alert_file_not_found' => 'Permiso denegado o el arcivo no se ha encontrado',
        ...
        'alert_rename_disabled' => 'El renombre de archivo/carpeta está deshabilitado, compruebe la configuración del administrador de imágenes/medios.',
        ...
        'alert_upload_disabled' => 'La subida está desactivada, compruebe la configuración del administrador de imágenes/medios.',
        ...
        'alert_success_delete' => 'Archivo(s) eliminado correctamente',
    ],

    'home' => [
        'title' => 'Pedido en línea!',
        'text_step_one' => 'Búscar',
        ...
        'text_step_pay' => 'Es rápido, fácil y seguro. Pague en efectivo en entrega o PayPal.',
    ...
    'account' => [
        ...
        'login' => [
            ...
            'text_forgot' => '¿Olvidaste la contraseña?',
    ...
    'settings' => [
        ...
        'text_tab_desc_media_manager' => 'Configurar subida de medios, copiar, renombrar la configuración.',
    ],
];
