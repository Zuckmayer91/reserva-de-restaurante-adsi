...
return [
    ...
    'help_order_total' => 'El monto total que debe alcanzar el pedido para que esta pasarela de pago se active',
    ...
    'cod' => [
        ...
        'text_payment_title' => 'Pago contra entrega',
        'text_payment_desc' => 'Aceptar pago contra entrega durante la compra',
    ...
    'paypal' => [
        ...
        'text_payment_desc' => 'Permite a tus clientes realizar el pago mediante PayPal',
    ...
    'stripe' => [
        ...
        'label_transaction_mode' => 'Modo de transacción',
        'label_transaction_type' => 'Tipo de transacción',
        'label_test_secret_key' => 'Clave secreta para pruebas',
        'label_test_publishable_key' => 'Clave Publicable para prueba',
        'label_live_secret_key' => 'Clave secreta Real',
        'label_live_publishable_key' => 'Clave Publicable Real',
        'label_priority' => 'Prioridad',
        'label_status' => 'Estado',
    ],
    ...
    'mollie' => [
        ...
        'label_transaction_mode' => 'Modo de transacción',
        'label_test_api_key' => 'Clave API para pruebas',
        'label_live_api_key' => 'Clave API real',
    ],
    ...
    'square' => [
        ...
        'label_description' => 'Descripción',
        'label_transaction_mode' => 'Modo de transacción',
        'label_test_app_id' => 'ID de aplicación para prueba',
        'label_test_access_token' => 'Token de acceso para Prueba',
        'label_test_location_id' => 'ID de ubicación para prueba',
        ...
        'help_square' => 'Obtén las claves API de Square desde <a href="https://developer.squareup.com">aquí</a>',
    ],
];
