                    ...
                    <?php else: ?>
                        <button class="btn font-weight-bold p-0 dropdown-toggle text-secondary" type="button" data-bs-toggle="dropdown"><?php echo app('translator')->get('thoughtco.outofstock::default.button_nostock'); ?></button>
                    ...
                    <?php endif; ?>
<?php /**PATH C:\xampp\htdocs\torta/extensions/thoughtco/outofstock/views/form/stock_column.blade.php ENDPATH**/ ?>